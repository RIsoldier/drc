	      ...
	      <div class="row">
		      ...
		      <div class="card">
		        ...
		        <div class="card-content service-ct">
		          <h2><a href="{{url('products/'.$category->category.'')}}">{{ $category->category }}</a></h2>
		          <p></p>
		          <a href="{{ url('products/'.$category->category) }}" class="btn btn-default btn-raised tp-btn-more">more</a> </div>
		      </div>
		    </div>
		  	@endforeach  
	      </div>
